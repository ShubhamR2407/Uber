...
public class RiderServiceImpl implements RiderService {
    ...
    public RideDto cancelRide(Long rideId) {
        ...
        if(!rider.equals(ride.getRider())) {
            throw new RuntimeException("Rider does not own this ride, riderId: "+ rideId);
        }

        if(!ride.getRideStatus().equals(RideStatus.CONFIRMED)) {
            throw new RuntimeException("Ride can not be cancelled, rideStatus : "+ ride.getRideStatus());
        }
    ...
    public DriverDto rateDriver(Long rideId, Integer rating) {
        ...
        if(!rider.equals(ride.getRider())) {
            throw new RuntimeException("Rider is not the owner of this rider");
        }
